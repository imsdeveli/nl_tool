    		  ...
    		  <td style="padding:30px; background-color:#ffffff;">
				...
				<p style="margin-top:0em; margin-bottom:1em;">${props.ar3.Bod}.&nbsp;<a href="${props.ar3.URL}" target="_blank" style="font-weight:bold; color:#0095da; text-decoration: underline;">Learn more &gt;&gt;</a></p>	
	  			...
	  			<div align="center" style="border-bottom:2px solid black;">&nbsp;</div>
					...
					<p style="margin-bottom:1em;"><a href="https://tracking.legacyoffers.com/aff_c?offer_id=291&aff_id=1828&eid=MKT641504&externalchannel=ptr-email-relcont&aff_sub=ptr-relcont-nl-lift5" target="_blank" style="font-weight:bold; color:#0095da; text-decoration: underline;">The #1 Fuel Stock Set to Surge (Less than $20)</a></p>
	
						<p style="margin-bottom:1em;"><a href="https://www.behindthemarkets-btm.com/4RQSJ/KMKS9/?source_id=relcont&sub1=ptr&sub2=accurate&sub3=nl" target="_blank" style="font-weight:bold; color:#0095da; text-decoration: underline;">"Most Accurate Advisor Ever" Predicts July Crash. Get the Details Here.</a></p>
		
					<p style="margin-bottom:1em;"><a href="https://tracking.legacyoffers.com/aff_c?offer_id=289&aff_id=1828&eid=MKT641557" target="_blank" style="font-weight:bold; color:#0095da; text-decoration: underline;">3-Second Bitcoin Move</a></p>				
					...
					<p style="margin-bottom:1em;"><a href="https://pro.moneyandmarkets.com/m/1881732" target="_blank" style="font-weight:bold; color:#0095da; text-decoration: underline;">"IMPERIUM": The No. 1 Investment of the 2020s</a></p>
